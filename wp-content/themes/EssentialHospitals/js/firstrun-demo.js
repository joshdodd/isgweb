	...
	var intro = introJs();
          intro.setOptions({
            steps: [
              ...
              {
                element: '#membernetwork',
                intro: "America's Essential Hospitals is here to support and bring together people dedicated to higher quality, more accessible health care. Make good use of your new community! <a href='http://essentialhospitals.org/membernetwork/registration/'>Join the Member Network here.</a>"
              },
