...
foreach($results as $result){
	...
	if ($imis_id == ''){
		...
		if ($membertype == 'hospital'){
			echo "[$membertype] No iMIS ID";$i++; $imis_id = upload_user_fix($user_id); if ($imis_id){echo " New iMIS ID added: $imis_id";}else{echo " FAILED ADD!";}
			if ($i == 1)exit;
		}else{
