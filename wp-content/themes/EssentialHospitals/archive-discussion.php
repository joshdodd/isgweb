				...
				<div class="threefourth disc-content">
					<div class="panel">
						...
						<div class="gutter clearfix">
							...
							<div id="wrapDisc">
								<?php $args = array( 'post_type' => 'discussion', 'posts_per_page' => 10 );
										...
										<div class="discussion-entry">
											<div class="gutter clearfix">
												<div class="discussion-meta">
													...
													<p>Discussion Started by <?php echo get_user_meta('first_name'); ?> <?php echo get_user_meta('last_name'); ?> on <?php the_time('M j, g:i a');?> || <span class="orange"><em><?php comments_number( '(0 replies)', '(1 reply)', '(% replies)' ); ?></em></span></p>
												</div>
												<div class="discussion-user">
													<span><?php echo get_user_meta('first_name'); ?> <?php echo get_user_meta('last_name'); ?></span>
													<?php echo $authAv; ?>
												</div>
