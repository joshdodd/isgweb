                                                    ...
                                                    <tr>
                                                        <td style="padding:0px 0px 0px 0px;" valign="top" width="100%" rowspan="1" colspan="1" align="center">
                                                            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding-bottom:11px;height:1px;line-height:1px;" height="1" rowspan="1" colspan="1" align="center"><img height="1" vspace="0" border="0" hspace="0" width="5" style="display: block;" alt="" src="http://mlinson.staging.wpengine.com/wp-content/themes/EssentialHospitals/images/email/MNheader.png"></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                                                                                            ...
                                                                                            <table style="border-style: none; border-width: 0px; width: 100%; height: 100px;" cellspacing="0" cellpadding="0" align="none">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="background-color: #000; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 12px; vertical-align: center; color: #ffffff; font-size: 10pt; font-style: normal; font-weight: normal; width: 297px; font-family: Georgia, 'Times New Roman', Times, serif;" height="26" border="0" rowspan="1" cellpadding="0" colspan="1">
