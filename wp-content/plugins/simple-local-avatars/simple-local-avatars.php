...
class Simple_Local_Avatars {
	...
	?>
	<h3><?php _e( 'Upload/Edit Profile Image','simple-local-avatars' ); ?></h3>
		...
		<tr>
			...
			?>
					...
					<p>
						...
						<a href="<?php echo $remove_url; ?>" class="button item-delete submitdelete deletion" id="simple-local-avatar-remove"<?php if ( empty( $profileuser->simple_local_avatar ) ) echo ' style="display:none;"'; ?>><?php _e('Remove profile image','simple-local-avatars'); ?></a>
					</p>
			<?php
				} else {
